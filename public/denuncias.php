<?php
// filepath: c:\xampp\htdocs\mercado_admin\public\denuncias.php
...
require_once $ROOT . '/src/reports.php';
  ...
  <div class="bg-blackx2 border border-blackx3 rounded-2xl p-5">
    ...
    <form method="get" class="mb-4 rounded-2xl border border-blackx3 bg-blackx/50 p-3 md:p-4">
      <div class="flex flex-col md:flex-row md:items-end md:flex-nowrap gap-3">
        <div class="md:flex-1">
          ...
          <input name="q" value="<?= htmlspecialchars($f['q']) ?>" placeholder="Produto ou motivo" class="w-full bg-blackx border border-blackx3 rounded-xl px-4 py-2.5 outline-none focus:border-greenx">
        </div>
        <div class="md:w-40">
    ...
    <div class="overflow-x-auto">
      <table class="w-full text-sm">
        ...
        <?php endforeach; ?>
        <?php if (!$lista['itens']): ?><tr><td colspan="6" class="py-6 text-zinc-500">Nenhuma denúncia encontrada.</td></tr><?php endif; ?>
        </tbody>
      </table>
    </div>
